#esercizio partita di tennis Sinner vs Alcaraz
punteggio_uno = 0
punteggio_due = 0
...
if punteggio_uno == punteggio_due == 40 :  
    ...
    print (punteggio_uno , "-" , punteggio_due)
    while True :
        punto_finale = int(input("Inserisci il numero 1, se vince lo scambio dei Vantaggi, Sinner; 2 per Alcaraz: "))
        if punto_finale == 1 and punteggio_uno == 40 :
           punteggio_uno = "VANT"
           print("Punteggio:" , punteggio_uno , "-" , punteggio_due)
        elif punto_finale == 1 and punteggio_uno == "VANT" and punteggio_due == "VANT":
           punteggio_uno = "VANT"
           punteggio_due = 40
           print("Punteggio:" , punteggio_uno , "-" , punteggio_due)
        elif punto_finale == 1 and punteggio_uno == "VANT" :
           print ("Vince il game Sinner")
           break   
        elif punto_finale == 2 and punteggio_due == 40 :
           punteggio_due = "VANT"
           print("Punteggio:", punteggio_uno , "-" , punteggio_due )
        elif punto_finale == 2 and punteggio_uno == "VANT" and punteggio_due == "VANT":
           punteggio_uno = 40
           punteggio_due = "VANT"
           print("Punteggio:" , punteggio_uno , "-" , punteggio_due)
        else:
